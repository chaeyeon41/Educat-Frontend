...
import "./StudyMainFairyTravel.css";
import FairyTravelBasicLearning from "../../components/contents/fairyTravel/FairyTravelBasicLearning";
import FairyTravelBasicVerification from "./../../components/contents/fairyTravel/FairyTravelBasicVerification";
import FairyTravelDeepLearning from "./../../components/contents/fairyTravel/FairyTravelDeepLearning";
import FairyTravelDeepVerification from "./../../components/contents/fairyTravel/FairyTravelDeepVerification";
import { useLocation, useNavigate } from "react-router-dom";
import axios from "axios";

const StudyMainFairyTravel = () => {
  ...
  useEffect(() => {
    if (contents) {
      setQuestion(["", contents.basic.question, "", contents.deep.question]);
    }
  }, [contents]);
      ...
      <div className="container">
        <div className="studyMain-container">
          ...
          <div className="studyMain-box-container">
            {currentStep === 1 && (
              <FairyTravelBasicLearning contents={contents} />
            )}
            {currentStep === 2 && (
              <FairyTravelBasicVerification
                contents={contents}
                timer={timer}
            ...
            {currentStep === 3 && (
              <FairyTravelDeepLearning contents={contents} />
            )}
            {currentStep === 4 && (
              <FairyTravelDeepVerification contents={contents} timer={timer} />
            )}
          </div>
...
export default StudyMainFairyTravel;

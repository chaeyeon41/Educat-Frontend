...
import "./StudyMainGrammarLand.css";
import GrammarLandBasicLearning from "../../components/contents/grammarLand/GrammarLandBasicLearning";
import GrammarLandBasicVerification from "../../components/contents/grammarLand/GrammarLandBasicVerification";
import GrammarLandDeepLearning from "../../components/contents/grammarLand/GrammarLandDeepLearning";
import GrammarLandDeepVerification from "../../components/contents/grammarLand/GrammarLandDeepVerification";
import { useLocation, useNavigate } from "react-router-dom";
import axios from "axios";

const StudyMainGrammarLand = () => {
      ...
      <div className="container">
        <div className="studyMain-container">
          ...
          <div className="studyMain-box-container">
            {currentStep === 1 && (
              <GrammarLandBasicLearning contents={contents} />
            )}
            {currentStep === 2 && (
              <GrammarLandBasicVerification
                contents={contents}
                timer={timer}
            ...
            {currentStep === 3 && (
              <GrammarLandDeepLearning contents={contents} />
            )}
            {currentStep === 4 && (
              <GrammarLandDeepVerification contents={contents} timer={timer} />
            )}
          </div>
...
export default StudyMainGrammarLand;

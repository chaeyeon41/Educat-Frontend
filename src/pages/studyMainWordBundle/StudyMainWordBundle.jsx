...
import WordBundleBasicLearning from "../../components/contents/wordBundle/WordBundleBasicLearning";
import WordBundleBasicVerification from "../../components/contents/wordBundle/WordBundleBasicVerification";
import "./StudyMainWordBundle.css";
import WordBundleDeepLearning from "../../components/contents/wordBundle/WordBundleDeepLearning";
import WordBundleDeepVerification from "../../components/contents/wordBundle/WordBundleDeepVerification";
import timerImage from "./../../assets/timer.png";
import CheckBtn from "../../components/checkBtn/CheckBtn";
import { useLocation, useNavigate } from "react-router-dom";
import axios from "axios";
const StudyMainWordBundle = () => {
      ...
      <div className="container">
        <div className="studyMain-container">
          ...
          <div className="studyMain-box-container">
            {currentStep === 1 && (
              <WordBundleBasicLearning contents={contents} />
            )}
            {currentStep === 2 && (
              <WordBundleBasicVerification
                contents={contents}
                timer={timer}
            ...
            {currentStep === 3 && (
              <WordBundleDeepLearning contents={contents} />
            )}
            {currentStep === 4 && (
              <WordBundleDeepVerification contents={contents} timer={timer} />
            )}
          </div>
...
export default StudyMainWordBundle;

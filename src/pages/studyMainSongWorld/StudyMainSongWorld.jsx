...
import "./StudyMainSongWorld.css";
import SongWorldBasicLearning from "./../../components/contents/songWorld/SongWorldBasicLearning";
import SongWorldBasicVerification from "./../../components/contents/songWorld/SongWorldBasicVerification";
import SongWorldDeepLearning from "./../../components/contents/songWorld/SongWorldDeepLearning";
import SongWorldDeepVerification from "../../components/contents/songWorld/SongWorldDeepVerification";
import { useLocation } from "react-router-dom";
import axios from "axios";
import { useNavigate } from "react-router-dom";

const StudyMainSongWorld = () => {
      ...
      <div className="container">
        <div className="studyMain-container">
          ...
          <div className="studyMain-box-container">
            {currentStep === 1 && (
              <SongWorldBasicLearning contents={contents} />
            )}
            {currentStep === 2 && (
              <SongWorldBasicVerification
                contents={contents}
                timer={timer}
                handleNext={handleNext}
              />
            )}
            {currentStep === 3 && <SongWorldDeepLearning contents={contents} />}
            {currentStep === 4 && (
              <SongWorldDeepVerification contents={contents} timer={timer} />
            )}
          </div>
...
export default StudyMainSongWorld;

...
import "./StudyMainWordAbsorb.css";
import WordAbsorbBasicLearning from "../../components/contents/wordAbosrb/WordAbsorbBasicLearning";
import WordAbsorbBasicVerification from "../../components/contents/wordAbosrb/WordAbsorbBasicVerification";
import WordAbsorbDeepLearning from "../../components/contents/wordAbosrb/WordAbsorbDeepLearning";
import WordAbsorbDeepVerification from "../../components/contents/wordAbosrb/WordAbsorbDeepVerification";
import { useLocation } from "react-router-dom";
import axios from "axios";
import { useNavigate } from "react-router-dom";

const StudyMainWordAbsorb = () => {
      ...
      <div className="container">
        <div className="studyMain-container">
          ...
          <div className="studyMain-box-container">
            {currentStep === 1 && (
              <WordAbsorbBasicLearning contents={contents} />
            )}
            {currentStep === 2 && (
              <WordAbsorbBasicVerification
                contents={contents}
                timer={timer}
            ...
            {currentStep === 3 && (
              <WordAbsorbDeepLearning contents={contents} />
            )}
            {currentStep === 4 && (
              <WordAbsorbDeepVerification
                contents={contents}
                timer={timer}
                handleNext={handleNext}
              />
...
export default StudyMainWordAbsorb;

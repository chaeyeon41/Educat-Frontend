...
const SongCountryBasicLearning2 = ({ contents }) => {
      ...
      {contents && (
        <>
          <div
            ...
            onClick={() =>
              toggleAudio(contents.basic.countryTwoFiles[1].element)
            }
          >
            <div className="basic-learning-songcountry-img1">
              <img src="images/good2.png" alt="" />
            </div>
            <h2>{contents.basic.countryTwoFiles[1].sentence}</h2>
            <h3>{contents.basic.countryTwoFiles[1].sentenceMeaning}</h3>
          </div>
...
export default SongCountryBasicLearning2;

...
import "./SongWorldBasicVerification.css";
import CheckBtn from "../../checkBtn/CheckBtn";
import axios from "axios";

const SongWorldBasicVerification = ({ contents, timer, handleNext }) => {
  ...
  return (
    // <div className='song-world-verification-container'>
    // 	<div className='song-world-verification-image' onClick={toggleAudio}>
    // 		<img src="/images/logo/logo2.png" alt="동요이미지" />
    // 	</div>
    // 	<div className='song-world-verification-buttons'>
    // 		<button>farm</button>
    // 		<button>gold</button>
...
export default SongWorldBasicVerification;

...
import "./WordAbsorbBasicVerification.css";
import CheckBtn from "../../checkBtn/CheckBtn";
import axios from "axios";

const WordAbsorbBasicVerification = ({ contents, timer, handleNext }) => {
  ...
  const handleButtonClick = (item, index) => {
    ...
    console.log("content", contents.basic.studyResponse.id);
  };
  ...
  return (
    <>
      ...
      <div className="basic-learning-wordabsorb-three">
        {contents.basic.wordAbsorbThrees.map((item, index) => (
          <button
            key={index}
...
export default WordAbsorbBasicVerification;
